	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="./index.php?page=new_student"><i class="fa fa-plus"></i> Agregar Nuevo</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	$(document).ready(function(){
		...
		$('.view_student').click(function(){
			uni_modal("Detalles de Estudiantes","view_student.php?id="+$(this).attr('data-id'),"large")
		})
	$('.delete_student').click(function(){
	_conf("Estás segur@ que deseas eliminar este estudiante","delete_student",[$(this).attr('data-id')])
	})
	})
