...
<script>
	$(document).ready(function(){
		...
		$('.new_class').click(function(){
			uni_modal("Gestionar año escolar - Semestre","manage_class.php")
		})
		$('.manage_class').click(function(){
			uni_modal("Gestionar año escolar - Semestre","manage_class.php?id="+$(this).attr('data-id'))
		})
	$('.delete_class').click(function(){
	_conf("¿Estás segur@ de eliminar esta clase?","delete_class",[$(this).attr('data-id')])
	})
	})
