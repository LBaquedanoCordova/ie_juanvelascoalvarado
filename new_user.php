			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">No Contacto </label>
					...
					<div class="col-md-6">
						...
						<b class="text-muted">Credenciales de Sistema</b>
						<?php if($_SESSION['login_type'] == 1): ?>
						<div class="form-group">
							<label for="" class="control-label">Roll de Usuario</label>
	...
	$('[name="password"],[name="cpass"]').keyup(function(){
		...
		if(cpass == '' ||pass == ''){
			...
			if(cpass == pass){
				...
				$('#pass_match').attr('data-status','2').html('<i class="text-danger">Contraseña no coincide</i>')
			}
		}
	})
